package namoo.board.dom1.util.numeral;

import namoo.board.dom1.util.exception.NamooBoardException;
...
public class Numeral36 {
    ...
    public String getNextStr36(String str36) {
        ...
        if (str36.length() == 1 && str36.equals("Z")) {
            throw new NamooBoardException("Overflow, Z is the last char in one byte value -> " + str36);
        }
    ...
    public long getLong36(String str36) {
        ...
        if (str36 == null || str36.equals("")) {
            throw new NamooBoardException("Minus digit is not valid -> " + str36);
        }
    ...
    private String getStr36(long int36) {
        //
        String resultStr = "";

        if (int36 < 0) {
            throw new NamooBoardException("Minus digit is not valid -> " + int36);
        }
    ...
    private String format(String str36, int formatLength) {
        ...
        if (fillCount < 0) {
            throw new NamooBoardException("Formatted lenght is smaller than str36 length:" + str36);
        }
