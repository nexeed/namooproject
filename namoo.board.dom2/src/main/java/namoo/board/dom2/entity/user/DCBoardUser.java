...
public class DCBoardUser {
    ...
    public DCBoardUser(String email) {
        //
        this.email = email;
    }
    
    public DCBoardUser(String email, String name, String phoneNumber){
        //
        this.email = email; 
        this.name = name; 
    ...
    // da.jdbc
    public DCBoardUser(String email, String name){
        //
        this.email = email; 
        this.name = name; 
    }
