                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <c:forEach var="posting" items="${postings.results}">
                        <tr>
                            ...
                            <td><a href="${ctx}/board/${socialBoard.usid}/posting/${posting.usid}">${posting.title}</a>
                            </td>
           ...
           <!-- Pagination -->
            <div class="text-center">
                <ul class="pagination">
                    ...
                    <li><a href="${ctx}/board/${boardUsid}/postings?page=1">«</a></li>
                    <c:if test="${postings.getNavigateStartPage() ne 1}">
                    <li><a href="${ctx}/board/${boardUsid}/postings?page=${postings.getNavigateStartPage() -1}"></a></li>
                    </c:if>
                    ...
                    <c:forEach var="i" begin="${postings.getNavigateStartPage()}"
                      ...
                      <c:choose>     
	                      <c:when test="${postings.getPage() eq i }">   
	                      	<li class="active"><a href="${ctx}/board/${boardUsid}/postings?page=${i}">${i}</a></li>
	                      </c:when>
	                      <c:otherwise>
	                     	 <li><a href="${ctx}/board/${boardUsid}/postings?page=${i}">${i}</a></li>
	                      </c:otherwise>
                      </c:choose> 	
                    </c:forEach>
                    ...
                    <li><a href="${ctx}/board/${boardUsid}/postings?page=${postings.getNavigateStartPage() + postings.getNavigatePageCount()}">></a></li>
                    </c:if>
                    <li><a href="${ctx}/board/${boardUsid}/postings?page=${postings.getTotalPageCount()}">»</a></li>
                    </c:if>
            ...
            <div class="text-right">
                <a href="${ctx}/board/${socialBoard.usid}/posting/create">
